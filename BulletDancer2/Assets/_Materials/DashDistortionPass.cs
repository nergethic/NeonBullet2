...
public class DashDistortionPass : ScriptableRenderPass {
  ...
  public DashDistortionPass(string profilerTag, RenderPassEvent renderPassEvent, Material materialToBlit) {
